...
**Product:** Mobile application combining:
- AI-driven real-world experience/quest generation
- Peer-driven reputation system for trust and safety
- Vector-based identity and preference matching (no rigid categories)
- Reputation-gated access and progressive trust levels
...
- Class A and Class B have **identical economic rights** (dividends, distributions, liquidation proceeds) on a per-share basis.
- Class B carries no voting rights except as required by Delaware law.
- No conversion rights between classes.
- No preferred stock authorized or outstanding.
- No convertible notes, SAFEs, or other convertible instruments outstanding.
- No warrants outstanding.

### Shares Being Valued

**Class B Common Stock (Non-Voting)** — for purposes of setting the exercise price of stock options under the company's Equity Incentive Plan.
...
| Field | Value |
|-------|-------|
| **Plan Name** | Equity Incentive Plan |
| **Shares Reserved** | 1,500,000 Class B Common Stock |
| **% of Fully Diluted** | 15% |
...
| Item | Value |
|------|-------|
| **Authorized** | 10,000,000 Common Stock, $0.00001 par value |
| **Issued** | 10,000,000 (5,000,000 to each founder) |
| **Vesting** | 4-year, 1-year cliff on founder shares |
...
|------|--------|
| **Revenue (all time)** | $0 |
| **Cash on hand** | ~$85 (par value stock purchase, less formation costs) |
| **Debt** | $0 |
| **Accounts receivable** | $0 |
| **Accounts payable** | $0 (formation costs paid by founders personally) |
...
## 8. Key Risks and Considerations for Valuation
...
- **Dual-class structure** — Class B shares (being valued) are non-voting; discount for lack of marketability and lack of control applies

---

## 9. Requested Deliverables

1. Fair market value per share of **Class B Common Stock** as of the valuation date
2. Written valuation report sufficient to establish a safe harbor under IRC Section 409A
3. Report should address applicable discounts (DLOM, DLOC) for non-voting, illiquid shares in a pre-revenue subsidiary
4. Valuation valid for 12 months or until a material event (financing, acquisition, etc.)

---

## 10. Supporting Documents Available

The following documents are available for the appraiser's review upon request:
...
| Name | Role | Email |
|------|------|-------|
| Altin Lecaj | CEO | [email] |
| Eric Garcia | CTO | [email] |
